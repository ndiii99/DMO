...
class CameraKeluarView extends StatefulWidget {
  const CameraKeluarView({Key? key}) : super(key: key);

  @override
  State<CameraKeluarView> createState() => _CameraKeluarViewState();
}

class _CameraKeluarViewState extends State<CameraKeluarView> {
