...
class LaporanApprovalView extends GetView<LaporanApprovalController> {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<LaporanApprovalController>(
      init: LaporanApprovalController(),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            title: Text('Laporan Approval'),
