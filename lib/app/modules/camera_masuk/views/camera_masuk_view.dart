...
class CameraMasukView extends StatefulWidget {
  const CameraMasukView({Key? key}) : super(key: key);

  @override
  State<CameraMasukView> createState() => _CameraMasukViewState();
}

class _CameraMasukViewState extends State<CameraMasukView>
  ...
  Future takePicture() async {
    ...
    try {
      ...
      print('path');
      print(image!.path);
      Get.offAllNamed(Routes.ABSEN_MASUK, arguments: image!.path);
      //Get.
    } catch (e) {
      print(e.toString());
    }
